...
from subajuda import pedido,lanche,porcao
import requests
...
def main(page:ft.Page):
    ...
    def enviar_pedidos(e):
        if campo_lista.content.controls[1].content.controls==[]:
            ...
            print(len(campo_lista.content.controls[1].content.controls))
        ...
        elif len(campo_lista.content.controls[1].content.controls) <= 2:
            mensagem(text='por favor adicione algum item na lista antes de enviar!')
            ...
            total.update()
            campo_lista.update()
            response = requests.post(url= 'https://api-mamaes.onrender.com/Pedidos/', json={'todos_pedidos':pedido})
    ...
    def adiciona_item(e):
        if e.control.parent.controls[0].value == None or e.control.parent.controls[1].content.value == None:
            ...
            campo_lista.update()
            #atualizando campo_lanches tem que ser desse jeito por conta de bug na nova atualização do flet
            campo_lanches.controls[0] = ft.Dropdown(
                label='QTD',
                value=None,
            ...
            campo_lanches.controls[1].content = ft.Dropdown(
            label='LANCHES TRADICIONAIS',
            value=None,
            border_color=ft.colors.WHITE,
            width=210,
            icon_size=0,
            ...
            campo_artesanais.controls[0] =  ft.Dropdown(
                label='QTD',
                value=None,
                text_style=ft.TextStyle(color=ft.Colors.WHITE,weight=ft.FontWeight.BOLD),
                border_color=ft.colors.WHITE,
            ...
            campo_artesanais.controls[1].content = ft.Dropdown(
            label='LANCHES artesanais'.upper(),
            border_color=ft.colors.WHITE,
            width=210,
            icon_size=0,
            border_width=0.8,
            ...
            campo_bebidas.controls[0] = ft.Dropdown(
                label='QTD',
                border_color=ft.colors.WHITE,
                text_style=ft.TextStyle(color=ft.Colors.WHITE,weight=ft.FontWeight.BOLD),
                border_width=0.8,
            ...
            campo_bebidas.controls[1].content = ft.Dropdown(
            label='bebidas'.upper(),
            border_color=ft.colors.WHITE,
            width=210,
            icon_size=0,
            ...
            options=[
                ...
                ft.dropdown.Option(text='água S/gás 500 ml                                R$ 3.99'.upper()),
                ft.dropdown.Option(text='água c/gás 500 ml  R$ 4.99'.upper()),
            ]
        )
            campo_bebidas.update()

            campo_combos.controls[0] = ft.Dropdown(
                label='QTD',
                border_color=ft.colors.WHITE,
                text_style=ft.TextStyle(color=ft.Colors.WHITE,weight=ft.FontWeight.BOLD),
                border_width=0.8,
            ...
            campo_combos.controls[1].content = ft.Dropdown(
            label='combos'.upper(),
            border_color=ft.colors.WHITE,
            width=210,
            icon_size=0,
            ...
            campo_porcoes.controls[0] = ft.Dropdown(
                label='QTD',
                border_color=ft.colors.WHITE,
                text_style=ft.TextStyle(color=ft.Colors.WHITE,weight=ft.FontWeight.BOLD),
                border_width=0.8,
            ...
            campo_porcoes.controls[1].content = ft.Dropdown(
            label='porções'.upper(),
            width=210,
            icon_size=0,
            border_color=ft.colors.WHITE,
    ...
    def adiciona_mesa(e):
        ...
        if campo_mesa.controls[1].value == None:
            ...
            campo_mesa.controls[1] = ft.Dropdown(
